...
urlpatterns = [
    ...
    url(r'^api/get_chat_transcript/$', translator_views.api_get_chat_transcript, name='api_get_chat_transcript'),
    ...
    url(r'^api/get_persona_relationship/$', translator_views.api_get_persona_relationship, name='api_get_persona_relationship'),
